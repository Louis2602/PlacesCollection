...
const StyledTypography = styled(Typography)({
    ...
    fontWeight: 'bold',
    border: '4px solid',
    borderImage: 'linear-gradient(101deg, var(--pink--color), var(--orange--color)) 1',
    cursor: 'pointer',
            ...
            <Grid container spacing={2}>
                <Grid item md={12} lg={6}>
                    <Box>
                        ...
                        <StyledTypoQuote variant="h1" textAlign="start" fontWeight="bold" gutterBottom>
                            A{' '}
                            <span
                                style={{
                        ...
                        <StyledParagraph sx={{ display: 'block' }} mb="1rem">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae autem, natus illo in iure sequi laboriosam velit
                            perferendis vitae? Nulla.
                        </StyledParagraph>
                        <StyledTypography>
